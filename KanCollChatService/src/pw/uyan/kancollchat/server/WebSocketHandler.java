package pw.uyan.kancollchat.server;
...
import pw.uyan.kancollchat.main.NettyConfig;
import pw.uyan.kancollchat.main.WsMessage;
    ...
    private void handWsMessage(ChannelHandlerContext ctx, WebSocketFrame msg) {
        ...
        if(msg instanceof PingWebSocketFrame) {
            ...
            WsMessage wsMessage = gson.fromJson(message.text(), WsMessage.class);
                    // 广播消息
            broadcastWsMsg( ctx, new WsMessage(wsMessage.getMsgType(), wsMessage.getUserName(), wsMessage.getMsg()));
        }else {
